...
A Fabric server mod inspired by the LifeSteal SMP gamemode, for Minecraft 1.20.2.
...
The Netherite Chestplate and Dragon Egg are limited to one copy on the server at a
