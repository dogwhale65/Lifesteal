...
public class ReviveItemFactory {
    ...
    private static void applySkin(ItemStack head, String playerName) {
        // No TooltipDisplay component before 1.21.5, and PROFILE has no show_in_tooltip
        // flag here — an unresolved profile renders no extra tooltip line, so nothing
        // needs hiding on this target.
